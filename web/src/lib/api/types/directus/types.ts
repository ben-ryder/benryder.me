...
export type BlogPostsBlogPostTags = {
  blog_post_tags_id?: string | BlogPostTags | null;
  blog_posts_id?: string | BlogPosts | null;
  id: number;
};

export type BlogPostsRelatedBlogPosts = {
  blog_post?: string | BlogPosts | null;
  id: number;
  related_blog_post?: string | BlogPosts | null;
};
...
export type Footer = {
  ...
  date_updated?: string | null;
  id: string;
  navigation_links: any[] | FooterLink[];
...
export type Header = {
  ...
  navigation_links: any[] | HeaderLink[];
};

export type HeaderLink = {
  header_id?: string | Header | null;
  id: number;
  link_id?: string | Link | null;
  order?: number | null;
};
...
export type Home = {
  ...
  id: string;
  social_links: any[] | HomeSocialLink[];
};

export type HomeSocialLink = {
  home_id?: string | Home | null;
  id: number;
  order?: number | null;
  social_link_id?: string | SocialLink | null;
};
...
export type ProjectsProjectTags = {
  id: number;
  project_tags_id?: string | ProjectTags | null;
...
export type ProjectsRelatedProjects = {
  id: number;
  project?: string | Projects | null;
  related_project?: string | Projects | null;
};
...
export type CustomDirectusTypes = {
  ...
  home: Home;
  home_social_link: HomeSocialLink[];
  link: Link[];
  pages: Pages[];
